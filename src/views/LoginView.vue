...
const validationSchema = yup.object({
    ...
    password:yup.string().required('The paasword is required')
})
            ...
            <form class="space-y-6" @submit.prevent="onSubmit">
                ...
                <div>
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-sm">
                            <a href="#" class="font-semibold text-indigo-600 hover:text-indigo-500">Forgot Passoword?</a>
                        </div>
                    </div>
...
const onSubmit = handleSubmit(async (values) => {
    try {
        ...
        router.push({ name: 'event-list-view' }) // Redirect to the event list view after successful login
    } catch (error) {
