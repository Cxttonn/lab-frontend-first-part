...
const placeholderErrorClass = computed ( () => {
    ...
    : 'block w-full rounded-md border-0 py-1.5 text-red-700 shadow-sm rinq-1 ring-inset ring-red-300 placeholder:text-red-400 focus:ring-2 focus:ring-inset focus:ring-red-600 sm:text-sm sm: leading-6'
})
...
<template> 
    ...
    <div class="mt-2">
        ...
        v-bind="$attrs" 
        v-model="modelValue" :aria-describedbv="error ? '${uuid}-error' : undefined" 
